import { LocationModel, StockModel } from '..';

describe('StockModel', () => {
  test('should create a new stock with valid values', () => {
    // Arrange
    const location = { _id: '1' } as unknown as LocationModel;
    const quantity = 10;
    const productId = '123';
    const _id = '456';

    // Act
    const stock = new StockModel(location, quantity, productId, _id);
  ...
  test('should create a new stock with default values', () => {
    ...
    // Act
    const stock = new StockModel(location, quantity, productId);
