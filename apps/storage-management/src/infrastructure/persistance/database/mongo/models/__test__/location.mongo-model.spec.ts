...
describe('LocationMongoModel', () => {
  test('should create a new location with valid values', () => {
    ...
    // Act
    const location = new LocationMongoModel(name, description, address, _id);
  ...
  test('should create a new location with default values', () => {
    ...
    // Act
    const location = new LocationMongoModel(name, description, address);
